const promptExamples = [
  ...
  {
    entry:
      'Cuando el RSI14 de BTCUSDT caiga por debajo de 45 en velas de 1 hora, abrir posición long con 1000 USDT. Apalancamiento x3.',
    exit: 'Salir cuando el RSI14 de BTCUSDT supere el valor 60.',
  },
  // {
  //   entry:
  ...
  {
    entry:
      'Cuando el volumen de ADAUSDT supere su media móvil de 20 periodos en velas de 30 minutos, abrir posición short con 700 USDT. El cruce tiene que ser con un +0,5% de diferencia.',
    exit: 'Salir cuando el volumen de ADAUSDT caiga por debajo de su media móvil de 20 periodos. El cruce tiene que ser con un +0,5% de diferencia.',
  },
  // {
  //   entry:
